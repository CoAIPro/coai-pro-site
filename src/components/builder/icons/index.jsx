...
const Icons = () => {
    ...
    return (
        <div className="flex h-full relative">
            {/* Sidebar with controls and icon grid at the bottom */}
            <div className="w-80 border-r border-gray-200 p-4 flex flex-col gap-4 h-full relative">
                {/* Controls */}
                ...
                {/* Icon Grid at the Bottom */}
                <div className="mt-4">
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Icons</h4>
                                ...
                                {filteredIcons.map((icon, index) => (
                                    <Tooltip key={index}>
                                        <TooltipTrigger asChild>
                                            <button
                                                type="button"
                                                className="aspect-square min-w-[60px] min-h-[60px] rounded-lg hover:bg-gray-100 flex items-center justify-center transition-colors duration-200 border border-transparent hover:border-gray-200"
