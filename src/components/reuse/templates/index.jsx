                            ...
                            <div key={card?.id} className="relative p-[2px] rounded-2xl transition-all duration-300 group hover:bg-gradient-to-r hover:from-[#3997FF] hover:to-[#F882F2] shadow-[0px_26px_27px_0px_#A791D217]" >
                                <div className="bg-white dark:bg-black p-2 pb-5 rounded-2xl flex flex-col h-full border border-slate-200 group-hover:border-transparent">
                                    ...
                                    <div className="flex-1 flex items-end pl-2">
                                        <button className="flex items-center justify-center gap-3 text-dark dark:text-white px-5 py-2 bg-transparent hover:bg-gradient-to-r hover:from-[#3997FF] hover:to-[#F882F2] border border-slate-200 hover:text-white hover:border-transparent rounded-full duration-200 shadow-sm hover:shadow-none">
